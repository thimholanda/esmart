...
<form id="estquaalo" action="<?= $path ?>/estadias/estquaalo" method="post">
    ...
    <div id="pag_aloc_quartos_aloc" style="margin-top: 15px">
        ...
        <div class="row col-md-12 col-sm-12 quat_botoes2 text-center" style="margin-top: 20px; margin-bottom: 20px;">
            ...
            <button id="estchicri_bot_2" style="width: auto; display: inline-block; vertical-align: middle; margin: 0; float: right;" class="form-control btn-primary estquaalo" type="button"><i class="fa fa-check-circle"></i> <?= $rot_geralobot ?></button>
        </div>
    </div>
</form>
