...
$complete_url = $path . "gertelger/gertelcad";
?>
<div style="margin-top: 15px">
    <form action="<?= $complete_url ?>" method="post">
        ...
        <h3>Criação de tela</h3>
        <div>
            <label>Código</label>
            <input type="text" name="tela_codigo" id="tela_codigo"/>
            <label>Nome</label>
            <input type="text" name="tela_nome" id="tela_nome"/>
        </div>
...
<div id="seleciona-tipo" style="display:none">
    <form>
        ...
        <input type="hidden" value="texto" id="tipo_html_escolhido"/>
        <input type="hidden" value="0" id="campo_propriedade_escolhida"/>
        <label>Tipo de campo</label>
        <select name="tipo_elemento" onchange="altera_tipo_html_escolhido(this)">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div style="position:relative;width:200px;height:25px;border:0;padding:0;margin:0;">
                        ...
                        <input class="form-control" name="validador"  id="validador" style="position:absolute;top:0px;left:0px;width:183px;width:180px;width:180px;height:23px; height:21px;height:18px;" onfocus="this.select()" type="text">
                    </div>
                </div>
            </div>
        </div>
...
<div id="codigo-gerado"  style="display:none">
    <div id="exibe-codigo">
