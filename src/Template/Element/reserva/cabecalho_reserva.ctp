...
<div class="form-group col-md-12 col-sm-12" style="padding: 0; margin-bottom: 0;">
    <div class="col-md-6 col-sm-12" style="padding: 0;">
        <label class="col-md-12 col-sm-12" style="margin-bottom: 0px; padding: 0;"><?= $rot_resdocnum ?>: <b><?= $reserva_dados['documento_numero'] ?>-<?= $reserva_dados['quarto_item'] ?> – <?= $reserva_dados['documento_status_nome']?></b></label>
